...
public class KodiUtilsTest {
	...
	public void getNoOfEpisodes_weekdays_6_minute_shows() {
		assertEquals(KodiUtils.getNoOfEpisodes(THURSDAY, 6d).intValue(), 5);
	}

	@Test
	public void getNoOfEpisodes_weekdays_12_minute_shows() {
		assertEquals(KodiUtils.getNoOfEpisodes(MONDAY, 12d).intValue(), 3);
	}

	@Test
	void getNoOfEpisodes_friday_12_minute_shows() {
		assertEquals(KodiUtils.getNoOfEpisodes(FRIDAY, 12d).intValue(), 2);
	}
